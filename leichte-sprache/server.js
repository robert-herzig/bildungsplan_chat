...
const MODEL = process.env.OPENWEBUI_MODEL || process.env.MISTRAL_MODEL || "mistral-small-latest";
...
const PORT = process.env.LEICHTE_PORT || 5000;
const HOST = process.env.HOST || "127.0.0.1";
app.listen(PORT, HOST, () => {
  console.log("Leichte-Sprache server listening on http://" + HOST + ":" + PORT);
});
